...
import { ArrowLeft, ShieldAlert, Loader2, MessageSquare } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Fitur untuk melihat pesan dan notifikasi dari koperasi sedang dalam tahap pengembangan.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Di sini Anda akan dapat berkomunikasi dengan admin dan menerima notifikasi penting. Terima kasih atas kesabaran Anda.</p>
