...
import { ArrowLeft, ShieldAlert, Loader2, DollarSign } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-3xl font-headline font-bold text-primary">Manajemen Fasilitas</h1>
        </div>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Fitur untuk manajemen pengajuan fasilitas anggota sedang dalam tahap pengembangan.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Di sini Anda akan dapat meninjau, menyetujui, atau menolak pengajuan fasilitas dari anggota. Terima kasih atas kesabaran Anda.</p>
          <div className="mt-6 flex justify-center">
            <DollarSign className="h-32 w-32 text-muted opacity-20" />
          </div>
        </CardContent>
      </Card>
    </div>
