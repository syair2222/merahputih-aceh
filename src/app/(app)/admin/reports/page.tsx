...
import { ArrowLeft, ShieldAlert, Loader2, BarChart3 } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Fitur untuk melihat dan mengelola laporan keuangan koperasi sedang dalam tahap pengembangan.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Di sini Anda akan dapat melihat berbagai laporan keuangan, statistik, dan melakukan ekspor data. Terima kasih atas kesabaran Anda.</p>
          <div className="mt-6 flex justify-center">
            <BarChart3 className="h-32 w-32 text-muted opacity-20" />
          </div>
        </CardContent>
      </Card>
    </div>
